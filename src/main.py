...
def save_to_server(image, entry_time, exit_time, image_time):
    ...
    image_id = requests.post('http://192.168.0.28:8080/image', json=metadata).json()["id"]
    print(image_id)
    ...
    response = requests.patch('http://192.168.0.28:8080/image/{}'.format(image_id), files=imagefile)
